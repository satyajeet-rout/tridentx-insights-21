...
// import post1Hero from "@/assets/post1.png";

// // Warm galaxy background (same as blog)
...
//             {/* Back Button */}
//             <Link to="/blog">
//               <Button variant="ghost" className="mb-10 text-white hover:bg-white/10">
//                 <ArrowLeft className="mr-2 h-5 w-5" />
//                 Back to Blog
//               </Button>
//             </Link>

//             {/* Hero Image - Now using your real post1.png */}
//             <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-10 border border-white/10">
//               <img 
//                 src={post1Hero} 
...
//             {/* Title */}
//             <h1 className="text-5xl md:text-6xl font-black text-white mb-12 leading-tight drop-shadow-xl">
//               Crafting Captivating Headlines:<br />
//               <span className="text-glow">Your awesome post title goes here</span>
//             </h1>

//             {/* Article Content - Proper Headings */}
//             <div className="prose prose-lg max-w-none text-white/90 space-y-12">
//               <section>
...
//               <h3 className="text-3xl font-bold text-white mb-10">Related Posts</h3>
//               <div className="grid md:grid-cols-2 gap-8">
//                 <Link to="/post-3" className="group block">
//                   <div className="h-56 bg-gradient-to-br from-blue-600/30 via-teal-500/30 to-green-500/30 rounded-2xl mb-4 overflow-hidden border border-white/10 group-hover:border-primary/50 transition-all">
...
//                   <div className="h-56 bg-gradient-to-br from-indigo-600/40 via-blue-500/40 to-cyan-500/40 rounded-2xl mb-4 overflow-hidden border border-white/10 group-hover:border-primary/50 transition-all">
//                     <div className="flex items-center justify-center h-full text-6xl opacity-20">Galaxy</div>
//                   </div>
//                   <h4 className="text-xl font-semibold text-white group-hover:text-primary transition-colors">
...
// import cosmicBg from "@/assets/cosmic-lightning-storm-space-background.jpg"; // ← This is the one used on Contact

// const Post1 = () => {
//   return (
//     <>
//       {/* EXACT SAME BACKGROUND AS CONTACT PAGE */}
//       <div 
//         className="fixed inset-0 -z-10 bg-cover bg-center bg-no-repeat"
//         style={{ 
...
//         }}
//       />
//       <div className="fixed inset-0 -z-10 bg-black/70" /> {/* Perfect readability */}
...
//             {/* Hero Image - Your Real post1.png */}
...
//               Crafting Captivating Headlines:<br />
//               <span className="text-glow text-pink-300">Your awesome post title goes here</span>
//             </h1>
...
// Real images
import post1Hero from "@/assets/post1.png";      // Hero for this post
import post2Hero from "@/assets/post2.png";      // Related: Post 2
import cesHero from "@/assets/CES_1.webp";        // Related: Post 3
      ...
      <div className="relative min-h-screen">
        ...
        <article className="pt-32 pb-24">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            {/* Related Posts — Now using REAL post2.png and CES_1.webp */}
            <div className="mt-24 pt-16 border-t border-white/20">
              <h3 className="text-3xl font-bold text-white mb-12">Related Posts</h3>
              <div className="grid md:grid-cols-2 gap-10">
                ...
                {/* Post 2 - The Art of Drawing Readers In */}
                <Link to="/post-2" className="group block">
                  <div className="relative rounded-3xl overflow-hidden shadow-xl mb-6 border border-white/20 group-hover:border-primary transition-all">
                    <img 
                      src={post2Hero} 
